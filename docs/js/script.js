...
window.addEventListener('DOMContentLoaded', function () {
  try {
    document.querySelector('.showup__intro .btn').addEventListener('click', function () {
  ...
  new _modules_difference__WEBPACK_IMPORTED_MODULE_5__["default"]('.officerold', '.officernew', '.officer__card-item').init();
    ...
    value: function hideItems(items) {
      ...
      items.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
          ...
          _this.newItems[_this.newCounter].classList.remove('animate__animated', 'animate__fadeIn');
        }
      });
    }
  }, {
...
/*#__PURE__*/
function () {
  function ShowInfo(triggers, content) {
      ...
      try {
        ...
        if (n === 3) {
          ...
          setInterval(function () {
            _this.handson.style.opacity = '1';

            _this.handson.classList.add('animate__slideInUp');
          }, 3000);
        } else {
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    key: "interval",
    value: function interval(slides, prev, next) {
      var _this4 = this;
